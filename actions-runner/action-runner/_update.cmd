...
set rootfolder=D:\My Projects\ToDoApplication\actions-runner
set existrunnerversion=2.309.0
set downloadrunnerversion=2.320.0
set logfile=D:\My Projects\ToDoApplication\actions-runner\_diag\SelfUpdate-20241121-151029.log
...
if %restartinteractiverunner% equ 1 (
  ...
  endlocal
  start "Actions Runner" cmd.exe /k "D:\My Projects\ToDoApplication\actions-runner\run.cmd"
) else (
  endlocal
)
